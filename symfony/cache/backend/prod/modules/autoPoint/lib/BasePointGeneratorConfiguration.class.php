...
abstract class BasePointGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%name%% - %%placed_date%% - %%longitude%% - %%latitude%% - %%altitude%% - %%local_name%% - %%line%%';
  }
  ...
  {
    return array(  0 => 'name',  1 => 'placed_date',  2 => 'longitude',  3 => 'latitude',  4 => 'altitude',  5 => 'local_name',  6 => 'line',);
  }
